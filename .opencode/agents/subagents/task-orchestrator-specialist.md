---
description: Execute end-to-end task delivery workflow from Taskmaster intake to PR creation by delegating every action to specialist subagents.
mode: subagent
temperature: 0
tools:
  bash: false
...
# Agent: task-orchestrator-specialist
